...
class Renderer implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            objects[0] = loadObject(ResourceRetriever.getResourceAsStream("resources/demos/data/models/Sphere.txt"));					// Load The First Object Into morph1 From File sphere.txt
            objects[1] = loadObject(ResourceRetriever.getResourceAsStream("resources/demos/data/models/Torus.txt"));					// Load The Second Object Into morph2 From File torus.txt
            objects[2] = loadObject(ResourceRetriever.getResourceAsStream("resources/demos/data/models/Tube.txt"));					// Load The Third Object Into morph3 From File tube.txt
            helper = loadObject(ResourceRetriever.getResourceAsStream("resources/demos/data/models/Sphere.txt"));// Load sphere.txt Object Into Helper (Used As Starting Point)
        } catch (IOException e) {
