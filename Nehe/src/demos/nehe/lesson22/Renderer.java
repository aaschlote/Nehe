...
class Renderer implements GLEventListener {
    ...
    private void loadGLTextures(GL gl, GLU glu) throws IOException {                                   // Load PNGs And Convert To Textures
        TextureReader.Texture texture = TextureReader.readTexture("resources/demos/data/images/Base.bmp");
        ...
        texture = TextureReader.readTexture("resources/demos/data/images/Bump.bmp");  // Load The Bumpmaps
        ...
        texture = TextureReader.readTexture("resources/demos/data/images/OpenGL_Alpha.bmp", true); // Load The Logo-Pngs
        ...
        texture = TextureReader.readTexture("resources/demos/data/images/OpenGL.bmp", true);
        ...
        texture = TextureReader.readTexture("resources/demos/data/images/Multi_On_Alpha.bmp", true);// Load The "Extension Enabled"-Logo
        alpha = BufferUtil.newByteBuffer(texture.getPixels().limit());                             // Create Memory For RGBA8-Texture

        for (int a = 0; a < alpha.capacity(); a += 4)
            alpha.put(a + 3, texture.getPixels().get(a));                                  // Pick Only Red Value As Alpha!

        texture = TextureReader.readTexture("resources/demos/data/images/Multi_On.bmp", true);
