...
class Renderer implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            dieSample = new AudioSample(ResourceRetriever.getResourceAsStream("resources/demos/data/samples/Die.wav"));
            completerSample = new AudioSample(ResourceRetriever.getResourceAsStream("resources/demos/data/samples/Complete.wav"));
            freezeSample = new AudioSample(ResourceRetriever.getResourceAsStream("resources/demos/data/samples/Freeze.wav"));
            hourglassSample = new AudioSample(ResourceRetriever.getResourceAsStream("resources/demos/data/samples/Hourglass.wav"));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
