...
class Renderer implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            loadTexture("resources/demos/data/images/Font.bmp", tex, drawable);               // Load the font texture
        } catch (IOException e) {
        ...
        try {
            loadTexture("resources/demos/data/images/HardGlow2.bmp", gCamera.m_GlowTexture, drawable);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        ...
        try {
            loadTexture("resources/demos/data/images/BigGlow3.bmp", gCamera.m_BigGlowTexture, drawable);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        ...
        try {
            loadTexture("resources/demos/data/images/Halo3.bmp", gCamera.m_HaloTexture, drawable);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        ...
        try {
            loadTexture("resources/demos/data/images/Streaks4.bmp", gCamera.m_StreakTexture, drawable);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
