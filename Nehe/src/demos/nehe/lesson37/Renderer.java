...
class Renderer implements GLEventListener {
    ...
    private void readMesh() throws IOException {
        InputStream in = ResourceRetriever.getResourceAsStream("resources/data/models/Model.txt");
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            InputStream inputStream = ResourceRetriever.getResourceAsStream("resources/demos/data/models/Shader.txt");
            int info;
