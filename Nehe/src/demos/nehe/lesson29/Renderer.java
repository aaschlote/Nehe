...
class Renderer implements GLEventListener {
    ...
    public void init(GLAutoDrawable glDrawable) {
        ...
        try {
            readTextureData("resources/demos/data/images/monitor.raw", t1);				// Fill The Image Structure With Data
        ...
        try {
            readTextureData("resources/demos/data/images/gl.raw", t2);					// Fill The Image Structure With Data
        } catch (IOException e) {                                   // Nothing Read?
