...
class Renderer implements GLEventListener {
    ...
    private void setupWorld() throws IOException {
        ...
        try {
            in = new BufferedReader(new InputStreamReader(ResourceRetriever.getResourceAsStream("resources/demos/data/models/World.txt")));
            String line = null;
    ...
    private void loadGLTextures(GL gl, GLU glu) throws IOException {
        TextureReader.Texture texture = TextureReader.readTexture("resources/demos/data/images/mud.png");
