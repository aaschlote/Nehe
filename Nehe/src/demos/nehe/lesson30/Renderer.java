...
class Renderer implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            audioSample = new AudioSample(
                    ResourceRetriever.getResourceAsStream("resources/demos/data/samples/Explode.wav")
            );
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void loadGLTextures(GL gl) {
        ...
        try {
            image1 = TextureReader.readTexture("resources/demos/data/images/Marble.bmp");
            image2 = TextureReader.readTexture("resources/demos/data/images/Spark.bmp");
            image3 = TextureReader.readTexture("resources/demos/data/images/Boden.bmp");
            image4 = TextureReader.readTexture("resources/demos/data/images/Wand.bmp");
        } catch (IOException e) {
            e.printStackTrace();
            throw new RuntimeException(e);
        }
